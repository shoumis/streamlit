...
def main():
    ...
    length_stay = st.number_input('How many days of stay are you planning for', min_value=0.5, max_value=365.0, value=0.5)
    ...
    comp_num = st.number_input('How many people are accompanying', min_value=0, max_value=100, value=0)
