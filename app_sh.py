...
# # Loading scaler
pickle_in = open("random_scaling_features.pkl", "rb")
...
def main():
    ...
    if main_acc == 'Hotel':
        ...
        hotel = 'Not Specified'
    travel_path = st.selectbox('Trough which medium you are traveling', ['Air', 'Sea', 'Land', 'Not Specified'])
    ...
    weight = st.number_input('How much will be your expected baggage weight in pounds?', min_value=0.0, max_value=10000.0, value=0.0)
    shop_exp = st.number_input('How much dollars you wish to spend on shopping?', min_value=0.0, value=0.0)
